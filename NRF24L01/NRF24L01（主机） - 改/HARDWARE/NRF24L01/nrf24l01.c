...
const u8 TX_ADDRESS[TX_ADR_WIDTH]={0x56,0x77,0x10,0x28,0x66};
const u8 RX_ADDRESS[RX_ADR_WIDTH]={0x56,0x77,0x10,0x28,0x66};//并联腿狗
...
{ 	
  ...
  SPI_InitTypeDef  SPI_InitStructure;
	...
	GPIO_ResetBits(GPIOA,GPIO_Pin_6|GPIO_Pin_7|GPIO_Pin_8);//PG6,7,8上拉					 
